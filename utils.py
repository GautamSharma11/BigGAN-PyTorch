...
dset_dict = {'I32': dset.ImageFolder, 'I64': dset.ImageFolder, 
             ...
             'C10': dset.CIFAR10, 'C100': dset.CIFAR100 , 'emotic': dset.EmoticDataset}
imsize_dict = {'I32': 32, 'I32_hdf5': 32,
               'I64': 64, 'I64_hdf5': 64,
               'I128': 128, 'I128_hdf5': 128,
               'I256': 256, 'I256_hdf5': 256,
               'C10': 32, 'C100': 32, 'emotic': 256}
root_dict = {'I32': 'ImageNet', 'I32_hdf5': 'ILSVRC32.hdf5',
             'I64': 'ImageNet', 'I64_hdf5': 'ILSVRC64.hdf5',
             'I128': 'ImageNet', 'I128_hdf5': 'ILSVRC128.hdf5',
             'I256': 'ImageNet', 'I256_hdf5': 'ILSVRC256.hdf5',
             'C10': 'cifar', 'C100': 'cifar', 'emotic': 'kaggle/input/emotic/img_arrs'}
nclass_dict = {'I32': 1000, 'I32_hdf5': 1000,
               'I64': 1000, 'I64_hdf5': 1000,
               'I128': 1000, 'I128_hdf5': 1000,
               'I256': 1000, 'I256_hdf5': 1000,
               'C10': 10, 'C100': 100, 'emotic': 26}
  ...
  if 'hdf5' in dataset:
    ...
    if augment:
      ...
      if dataset in ['C10', 'C100']:
        ...
        train_transform = [transforms.ToPILImage() ,CenterCropLongEdge(), transforms.Resize(image_size)]
...
def load_weights(G, D, state_dict, weights_root, experiment_name, 
                 name_suffix=None, G_ema=None, strict=False, load_optim=True):
  root = '/'.join([weights_root, experiment_name])
  if name_suffix:
